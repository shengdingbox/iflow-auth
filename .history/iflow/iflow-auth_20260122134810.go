...
// NewIFlowAuth constructs a new IFlowAuth with default HTTP client.
func NewIFlowAuth() *IFlowAuth {
	return &IFlowAuth{httpClient: &http.Client{Timeout: 30 * time.Second}}
}

// NewIFlowAuthWithClient constructs a new IFlowAuth with custom HTTP client.
func NewIFlowAuthWithClient(client *http.Client) *IFlowAuth {
	return &IFlowAuth{httpClient: client}
}
